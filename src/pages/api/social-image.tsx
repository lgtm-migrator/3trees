...
import { getBlockTitle, getBlockIcon, getPageProperty, isUrl, parsePageId } from 'notion-utils'
              ...
              <div className="horiz">
                <div className="lhs">
                  ...
                  <div className="metadata">
                    {authorImage && <div className="author-image" style={{ backgroundImage: `url(${authorImage})` }} />}
                ...
                {image && <img src={image} className="rhs" style={{ objectPosition: imageObjectPosition || undefined }} />}
              </div>
            </div>
          </body>
        </html>
